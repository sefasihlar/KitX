        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VaccineInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiseaseInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DrugInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Age = table.Column<double>(type: "float", nullable: true),
                    Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Kg = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalProductFeature", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnimalProductFeature_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BelongingProductFeature", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BelongingProductFeature_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lonqitude = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Condition = table.Column<bool>(type: "bit", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tall = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonProductFeature", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonProductFeature_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialProductFeature", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecialProductFeature_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Asn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IPAddresses_QrCodes_ProductId",
                        column: x => x.ProductId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Owners_QrCodes_ProductId",
                        column: x => x.ProductId,
                        principalTable: "QrCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalProductFeature_ProductId",
                table: "AnimalProductFeature",
                column: "ProductId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BelongingProductFeature_ProductId",
                table: "BelongingProductFeature",
                column: "ProductId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IPAddresses_ProductId",
                table: "IPAddresses",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_ProductId",
                table: "Owners",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonProductFeature_ProductId",
                table: "PersonProductFeature",
                column: "ProductId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialProductFeature_ProductId",
                table: "SpecialProductFeature",
                column: "ProductId",
                unique: true);
